...
class BIM(Attack):
    ...
    def __init__(self, model, eps=8 / 255, alpha=2 / 255, steps=10, at_map = None):
    ...
    def forward(self, images, labels):
        ...
        for _ in range(self.steps):
            ...
            if self.at_map ==None:
                ...
                adv_images = images + self.alpha * grad.sign() * self.at_map
            a = torch.clamp(ori_images - self.eps, min=-1)
